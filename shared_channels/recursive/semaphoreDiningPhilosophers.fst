...
-- philosopher : Int -> SharedFork -> SharedFork -> Semaphore -> ()
-- philosopher id left right sem  =
...
main =   
    ...
    -- philosopher 12 f12 f11 s12 s11;
